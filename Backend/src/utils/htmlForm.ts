...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Dropdown arrow for custom select */
        .select-wrapper {
            position: relative;
            width: 100%;
        }
...
<body>
    ...
    <div class="container">
                ...
                <div class="form-grid">
                    ...
                    <div class="input-group full-width">
                        ...
                        <div class="input-wrapper">
                            ...
                            <div class="input-icon">
                                <svg viewBox="0 0 24 24">
                                    <path d="M12 3L1 9l11 6 9-4.91V17h2V9L12 3zM5.89 12.55L12 15.89l6.11-3.34c.66-.36 1.11-1.05 1.11-1.83V9.7L12 13.7 4.78 9.7v1.02c0 .78.45 1.47 1.11 1.83z"/>
                                </svg>
                            </div>
                        </div>
                    </div>
        ...
        <div id="success-state" class="card feedback-state">
            ...
            <p class="feedback-desc">Tus datos han sido guardados correctamente en la base de datos de MPOLOG. ¡Muchas gracias por tu registro!</p>
    ...
    <script>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                // Post directly to the public endpoint on the same origin (relative path)
