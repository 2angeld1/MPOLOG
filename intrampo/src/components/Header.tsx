    ...
    <header className="fixed top-0 left-0 lg:left-[260px] right-0 h-[70px] bg-[#14161f]/80 backdrop-blur-[20px] border-b border-white/10 flex items-center justify-between px-4 lg:px-8 z-[90] transition-all duration-300">
      ...
      <div className="flex items-center gap-4">
        {canEdit && (
          ...
          >
            <span>✏️</span> {isEditMode ? 'Editando' : 'Modo Edición'}
          </button>
        )}
        <div className="relative hidden md:block group">
          <svg xmlns="http://www.w3.org/2000/svg" className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 pointer-events-none" viewBox="0 0 20 20" fill="currentColor">
